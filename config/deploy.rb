...
set :wp_user, "morgansinclair" # The admin username
set :wp_email, "e.cressey@mixd.co.uk" # The admin email address
set :wp_sitename, "Morgan Sinclair photography" # The site title
set :wp_localurl, "http://morgansinclairphotography.dev" # Your local environment URL

############################################
# Setup project
############################################

set :application, "morgansinclairphotography"
set :repo_url, "git@github.com:emilyvc/morgansinclairphotography.git"
set :scm, :git
